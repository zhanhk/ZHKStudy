 ...
 * @Desc:
 * @Author: zhanhk
 * @Date: Created in 上午10:10 18/11/21
...
public class ZuulConfiguration {
    ...
    private Map<Integer, ChannelInitializer> choosePortsAndChannels(ChannelGroup clientChannels, ChannelConfig channelDeps) {
        ...
        portsToChannels.put(zuulPort, new ZuulServerChannelInitializer(zuulPort, channelConfig, channelDeps, clientChannels));
    ...
    public EurekaInstanceConfig eurekaInstanceConfig() {
        return new AbstractInstanceConfig() {
            ...
            public String[] getDefaultAddressResolutionOrder() {
                return new String[]{"http://localhost:8761/eureka"};
            }
